  ...
  class SurveyHtmlFormPlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.preamble !== null) {
              html +=
                  '<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble" style="color: rgb(109, 112, 114);">' +
                      trial.preamble +
                      "</div>";
          }
          // start form
          if (trial.autocomplete) {
              html += '<form id="jspsych-survey-html-form" style="color: rgb(109, 112, 114);">';
          }
          else {
              html += '<form id="jspsych-survey-html-form" style="color: rgb(109, 112, 114);" autocomplete="off">';
          }
